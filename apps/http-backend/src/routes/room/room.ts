...
roomRouter.post("/createroom", authUser, async (req: Request, res: Response) => {
   try {
      const body = req.body;
...
roomRouter.get("/detail/:roomId", authUser, async (req: Request<RoomParams>, res) => {
   try {
...
roomRouter.post("/joinroom", authUser, async (req: Request<RoomParams>, res: Response) => {
   try {
      const body = req.body;
...
roomRouter.get("/searchRoom/:searchRoomName", authUser, async (req: Request, res: Response) => {
